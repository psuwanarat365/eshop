...
describe('Users Selectors', () => {
    ...
    describe('Users Selectors', () => {
        it('selectAllUsers() should return the list of Users', () => {
            const results =
                UsersSelectors.selectAllUsers(state);
        ...
        it('selectEntity() should return the selected Entity', () => {
            const result = UsersSelectors.selectEntity(
                state
            ) as UsersEntity;
        ...
        it('selectUsersLoaded() should return the current "loaded" status', () => {
            const result =
                UsersSelectors.selectUsersLoaded(state);
        ...
        it('selectUsersError() should return the current "error" state', () => {
            const result =
                UsersSelectors.selectUsersError(state);
